...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-gray-600">
            <a href="#home" className="hover:text-blue-600 transition-colors">홈</a>
            <a href="#backlink-types" className="hover:text-blue-600 transition-colors">백링크유형</a>
            <a href="#success-cases" className="hover:text-blue-600 transition-colors">성공사례</a>
            <a href="#products" className="hover:text-blue-600 transition-colors">상품</a>
            <a href="#process" className="hover:text-blue-600 transition-colors">프로세스</a>
      ...
      {/* 히어로 섹션 */}
      <section id="home" className="relative pt-32 pb-20 px-6 overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/30 backdrop-blur-md border border-red-300/50 text-white text-sm font-semibold mb-6 animate-pulse">
              🛑 효과 없는 백링크 업체에 돈만 버리고 계신가요?
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              플랜 백링크부터 PBN, 내부 최적화까지<br />
              <span className="text-yellow-300">맞춤형 SEO 솔루션</span>으로<br />
              <span className="underline decoration-yellow-300">2~4주 내 순위 상승</span>을 경험하세요
            </h1>

            <div className="space-y-3 mb-8 text-lg md:text-xl text-white/95">
              <p className="flex items-center justify-center gap-3">
                <span className="text-yellow-300 text-xl">✓</span>
                <span><strong>10가지 이상 백링크 유형</strong> (WEB2.0, EDU, GOV, Wiki 등)</span>
              </p>
              <p className="flex items-center justify-center gap-3">
                <span className="text-yellow-300 text-xl">✓</span>
                <span><strong>직접 구축한 PBN 네트워크</strong></span>
              </p>
              <p className="flex items-center justify-center gap-3">
                <span className="text-yellow-300 text-xl">✓</span>
                <span><strong>주문 즉시 10분 내 작업 시작</strong></span>
              </p>
              <p className="flex items-center justify-center gap-3">
                <span className="text-yellow-300 text-xl">✓</span>
                <span><strong>1,247명이 순위 상승 중</strong></span>
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-12">
              ...
              <div className="pt-8 border-t border-white/10 text-center">
                ...
                <p className="text-gray-300 text-lg">
                  망설이는 동안 경쟁사는 1페이지를 차지하고, 당신의 고객을 빼앗아갑니다<br />
                  <strong className="text-yellow-300">지금이라도 바꾸지 않으면 내일은 더 늦습니다</strong>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              95%의 국내 SEO 업체는<br />당신을 속이고 있습니다
            </h2>
            <p className="text-xl text-white/90">
              대부분의 국내 백링크 업체는 <strong className="text-yellow-300">KWORK, FIVERR</strong> 같은<br />
            ...
            <div className="rounded-2xl bg-red-800/50 border border-red-700 p-8">
              ...
              <ul className="space-y-4 text-white/90">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-red-300">KWORK/FIVERR에서 $5~20에 구매</strong> → 스팸 링크를 고가에 재판매</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-400 mt-1 font-bold text-xl">✕</span>
                  <span><strong className="text-red-300">스팸 링크를 고가에 재판매</strong> → 전혀 효과 없음</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-400 mt-1 font-bold text-xl">✕</span>
                  <span><strong className="text-red-300">프로 없고 오히려 패널티 위험</strong> → 1년 노력 물거품</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-400 mt-1 font-bold text-xl">✕</span>
                  <span><strong className="text-red-300">책임은 고객에게 전가</strong> → 환불도 안 됨</span>
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl bg-green-900/50 border border-green-700 p-8">
              ...
              <ul className="space-y-4 text-white/90">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-green-300">직접 구축한 PBN 네트워크</strong> → 완전히 우리 것</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 mt-1 font-bold text-xl">✓</span>
                  <span><strong className="text-green-300">10가지 이상 백링크 유형 직접 운영</strong> → WEB2.0, EDU, GOV, Wiki 등</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 mt-1 font-bold text-xl">✓</span>
                  <span><strong className="text-green-300">주문 즉시 10분 내 작업 시작</strong> → 자동 처리</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 mt-1 font-bold text-xl">✓</span>
                  <span><strong className="text-green-300">투명한 프로세스와 리포트</strong> → 엑셀 리포트 제공</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              10가지 이상 백링크 유형으로<br />자연스러운 링크 프로필 구축
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              구글은 다양한 소스에서 자연스럽게 생긴 백링크를 선호합니다<br />
              <strong className="text-blue-600">백링크샵은 10가지 이상의 백링크 유형을 직접 운영</strong>합니다
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-8 border-2 border-blue-200">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <p className="text-gray-600">고품질 백링크<br />→ 고객 사이트</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-cyan-600 mb-2">티어2</div>
                <p className="text-gray-600">중간 링크<br />→ 티어1 강화</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-teal-600 mb-2">티어3</div>
                <p className="text-gray-600">대량 링크<br />→ 티어2 강화</p>
              </div>
            </div>
          </div>
      ...
      <section id="success-cases" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <div className="text-8xl mb-6">🎉</div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              1,247개 프로젝트에서 증명된<br />실제 순위 상승 사례
            </h2>
            <p className="text-xl text-gray-600">
              말보다 증거. 백링크샵 고객들의 진짜 성과입니다
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-12">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 p-8 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-gray-900">47위 → <span className="text-green-600 text-xl">3위</span></span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-gray-900">320 → <span className="text-blue-600 text-xl">4,200명</span></span>
                </div>
            ...
            <div className="rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-8 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">순위</span>
                  <span className="font-bold text-gray-900">검색 안됨 → <span className="text-green-600 text-xl">7위</span></span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">기간</span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-gray-900">12건 → <span className="text-blue-600 text-xl">89건</span></span>
                </div>
                <div className="p-3 bg-yellow-100 rounded-lg text-center">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 p-8 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">순위</span>
                  <span className="font-bold text-gray-900">23위 → <span className="text-green-600 text-xl">2위</span></span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">기간</span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-gray-900">1.2% → <span className="text-blue-600 text-xl">4.8%</span></span>
                </div>
                <div className="p-3 bg-yellow-100 rounded-lg text-center">
            ...
            <div className="rounded-2xl bg-white border-2 border-blue-200 p-8 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700"><strong>상품 페이지 순위 상승</strong><br />상위 노출로 매출 직결</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 mt-1 text-xl">✓</span>
                  <span className="text-gray-700"><strong>자연 유입 증가</strong><br />광고비 절감 효과</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 mt-1 text-xl">✓</span>
                  <span className="text-gray-700"><strong>전환율 개선</strong><br />검색 유입이 가장 구매율 높음</span>
                </li>
              </ul>
            ...
            <div className="rounded-2xl bg-white border-2 border-green-200 p-8 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700"><strong>브랜드 인지도 확대</strong><br />검색 1페이지가 곧 신뢰도</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 mt-1 text-xl">✓</span>
                  <span className="text-gray-700"><strong>빠른 SEO 성과</strong><br />2~4주 내 순위 변화</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 mt-1 text-xl">✓</span>
                  <span className="text-gray-700"><strong>한정된 예산 최적화</strong><br />무료 크레딧으로 시작</span>
                </li>
              </ul>
            ...
            <div className="rounded-2xl bg-white border-2 border-purple-200 p-8 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700"><strong>클라이언트 성과 증명</strong><br />눈에 보이는 순위 상승</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1 text-xl">✓</span>
                  <span className="text-gray-700"><strong>투명한 리포트</strong><br />엑셀 리포트로 보고 간편</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-600 mt-1 text-xl">✓</span>
                  <span className="text-gray-700"><strong>안정적 파트너십</strong><br />화이트라벨 옵션 제공</span>
                </li>
              </ul>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto mb-12">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-6 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">사이트 수정 사항 안내</h3>
              <ul className="text-sm text-gray-600 space-y-2">
                <li>✓ 필수 수정 사항 목록</li>
                <li>✓ 온페이지 최적화 가이드</li>
                <li>✓ 내부 링크 구조 개선안</li>
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl p-8 text-center text-white shadow-xl">
            ...
            <p className="text-lg text-white/90 mb-6">
              무료 300 크레딧으로 진단 + 전략 제안을 먼저 받아보세요<br />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="rounded-2xl border-2 border-gray-200 bg-white p-8 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <p className="text-gray-600 text-sm mb-4">10가지 이상 백링크 유형으로 자연스러운 링크 프로필 구축</p>
            ...
            <div className="rounded-2xl border-2 border-blue-500 bg-white p-8 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all relative">
              ...
              <p className="text-gray-600 text-sm mb-4">직접 구축한 고품질 PBN 네트워크로 강력한 순위 상승</p>
              <ul className="text-sm text-gray-600 space-y-2 mb-6">
                <li>✓ 직접 구축한 네트워크</li>
                <li>✓ 고품질 보장</li>
                <li>✓ 티어 구조 지원</li>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto space-y-6 hidden">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-blue-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 일반 백링크 업체와 백링크샵의 차이는 무엇인가요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-blue-600">백링크샵은 100% 자체 인프라를 운영합니다.</strong> 95%의 업체는 KWORK/FIVERR에서 저렴한 스팸 SEO를 $5~20에 구매해 재판매하지만, 백링크샵은 직접 구축·운영하는 PBN과 10가지 이상 백링크 유형을 보유했습니다. 주문 즉시 10분 내 작업이 자동으로 시작되며, 완료 후에는 상세한 엑셀 리포트를 제공합니다. <strong className="text-gray-900">중간 마진 없이 순수한 가격</strong>으로 제공합니다.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-purple-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 왜 95% 업체는 KWORK/FIVERR를 사용하나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-purple-600">자체 인프라 구축 비용이 수천만 원 이상이기 때문입니다.</strong> 대부분의 업체는 PBN을 직접 구축하지 못하고, 해외 플랫폼에서 저렴한 링크를 구매해 고가에 재판매합니다. 하지만 이런 링크는 수백 개 사이트에 동시 판매되는 스팸 링크로, 효과가 없거나 오히려 패널티 위험이 있습니다. 백링크샵은 초기 투자 수천만 원을 들여 직접 PBN을 구축했고, <strong className="text-gray-900">100% 독점 링크만 제공</strong>합니다.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-green-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 백링크샵은 정말 직접 구축한 PBN인가요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-green-600">네, 100% 자체 구축 PBN입니다.</strong> 우리는 도메인 구매부터 호스팅, 콘텐츠 생성, 관리까지 모든 것을 직접 운영합니다. 각 PBN 사이트는 고유한 IP, 다양한 호스팅 제공업체, 자연스러운 콘텐츠를 보유하고 있습니다. 의류 쇼핑몰 A사는 우리 PBN으로 3주 만에 47위에서 3위로 상승했고, 치과 클리닉 B는 5주 만에 검색 안 되던 상태에서 7위로 진입했습니다. <strong className="text-gray-900">이것이 직접 구축한 PBN의 힘</strong>입니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-yellow-500 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-yellow-600">네, 고품질 PBN은 매우 안전합니다.</strong> 저품질 PBN이 위험한 이유는 같은 IP, 같은 호스팅, 스팸 콘텐츠 때문입니다. 백링크샵은 각 사이트를 서로 다른 호스팅, 다양한 IP, 고유한 콘텐츠로 운영하며, 자연스러운 분산 링킹으로 패널티 위험을 제로로 만듭니다. 지난 3년간 1,247개 프로젝트에서 <strong className="text-gray-900">패널티 사례 0건</strong>을 기록 중입니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-red-500 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-red-600">저품질 링크를 사용하지 않는 한 패널티 위험은 거의 없습니다.</strong> 구글이 패널티를 주는 경우는 스팸 링크, 대량 자동 링크, 동일 패턴 반복 등입니다. 백링크샵은 자연스러운 링크 프로필 구축을 최우선으로 하며, 10가지 이상 백링크 유형을 조합해 다양성을 확보합니다. 또한 작업 전 사이트 진단을 통해 <strong className="text-gray-900">위험 요소를 사전에 제거</strong>합니다.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-indigo-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 저품질 백링크와 고품질 백링크의 차이는?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-indigo-600">저품질은 스팸 사이트에서 자동 생성되는 링크, 고품질은 관련성 있는 사이트에서 자연스럽게 생성되는 링크입니다.</strong> 저품질 링크는 효과가 없거나 오히려 순위를 떨어뜨리지만, 고품질 링크는 도메인 권위, 관련성, 앵커 텍스트 다양성을 갖추고 있습니다. 백링크샵은 DA 30 이상 사이트, 관련 콘텐츠, 자연스러운 앵커 텍스트를 보장하며, <strong className="text-gray-900">효과 없으면 전액 환불</strong>합니다.
              </p>
            </div>

            {/* 효과/성과 */}
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-cyan-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 백링크 효과는 언제부터 나타나나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-cyan-600">평균 2-4주 내에 초기 순위 변화가 나타납니다.</strong> 의류 쇼핑몰 A사는 3주 만에 47위에서 3위로 상승했고, 치과 클리닉 B는 5주 만에 검색 안 되던 상태에서 7위로 진입했습니다. 마케팅 툴 C사는 4주 만에 23위에서 2위로 올랐습니다. 단, 경쟁 강도에 따라 <strong className="text-gray-900">3-6개월에 걸쳐 안정적으로 상승</strong>하며, 한 번 오른 순위는 지속적으로 유지됩니다.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-teal-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 정말 2-4주 내에 순위가 오르나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-teal-600">네, 실제 고객 사례로 증명되었습니다.</strong> 의류 쇼핑몰 A사(3주, 47위→3위), 치과 클리닉 B(5주, 검색 안됨→7위), 마케팅 툴 C사(4주, 23위→2위) 등 수백 개 프로젝트에서 동일한 결과를 보였습니다. 하지만 키워드 경쟁도, 사이트 상태, 백링크 유형에 따라 차이가 있으며, <strong className="text-gray-900">경쟁이 심한 키워드는 3-6개월 소요</strong>될 수 있습니다. 무료 컨설팅에서 예상 기간을 정확히 알려드립니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-orange-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 소량으로 테스트할 수 있나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-orange-600">네, 가입 시 무료 300 크레딧을 제공합니다.</strong> 300 크레딧으로 플랜 백링크 1개 또는 사이트 진단 + 맞춤 전략 제안을 받을 수 있습니다. 리스크 없이 우리의 품질을 먼저 경험해보세요. 만족하시면 그때 결제하시면 되며, <strong className="text-gray-900">98%의 고객이 재구매</strong>합니다.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-lime-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 크레딧 시스템은 어떻게 작동하나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-lime-600">크레딧은 모든 서비스에 사용할 수 있는 포인트입니다.</strong> 1크레딧 = 1원 가치를 가지며, 플랜 백링크(500 크레딧~), PBN 백링크(1,000 크레딧~), 내부 최적화(800 크레딧~) 등 다양한 서비스에 사용 가능합니다. 크레딧은 무제한 보관되며 만료일이 없습니다. 10,000 크레딧 이상 충전 시 <strong className="text-gray-900">10-20% 보너스 크레딧 제공</strong>합니다.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-amber-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 무료 300 크레딧으로 무엇을 할 수 있나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-amber-600">사이트 진단 + 맞춤 전략 제안 또는 플랜 백링크 1개를 받을 수 있습니다.</strong> 사이트 진단에서는 현재 백링크 프로필 분석, 기술적 SEO 점검, 경쟁사 비교, 키워드 순위 현황을 파악하고, 맞춤 전략(백링크 유형, 티어 구조, 타임라인, 예산)을 제안합니다. 또는 플랜 백링크 1개(WEB2.0, 프로필, 포럼 등)로 <strong className="text-gray-900">직접 효과를 테스트</strong>할 수도 있습니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-rose-500 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-rose-600">네, 작업 미진행 시 100% 환불, 효과 없을 시 부분 환불이 가능합니다.</strong> 주문 후 작업 시작 전에는 100% 환불, 작업 완료 후 90일 내 순위 변화가 전혀 없으면 50% 환불해드립니다. 단, 사이트 수정 권장사항을 이행하지 않았거나, 구글 가이드라인 위반 사이트는 환불 대상에서 제외됩니다. <strong className="text-gray-900">3년간 환불 요청 0.8%</strong>로 고객 만족도가 매우 높습니다.
              </p>
            </div>

            {/* 프로세스 */}
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-violet-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 주문 후 얼마나 빨리 시작되나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-violet-600">주문 즉시 10분 내 자동으로 작업이 시작됩니다.</strong> 수동 처리가 아닌 자동화 시스템으로 운영되어, 결제 완료 후 10분 이내에 백링크 작업이 진행됩니다. 대시보드에서 실시간 진행 상황을 확인할 수 있으며, 작업 완료 시 이메일 알림과 함께 <strong className="text-gray-900">상세 엑셀 리포트(URL, DA, 앵커 텍스트 등)를 제공</strong>합니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-fuchsia-500 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-fuchsia-600">작업 완료 후 상세 엑셀 리포트를 제공합니다.</strong> 리포트에는 백링크 URL, 도메인 권위(DA), 앵커 텍스트, 백링크 유형, 작업 일자가 포함됩니다. 또한 구글 서치 콘솔 데이터와 연동하여 백링크 인덱싱 상태를 추적하고, <strong className="text-gray-900">매주 순위 변화 리포트</strong>를 이메일로 발송합니다. 투명한 프로세스로 신뢰를 드립니다.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-sky-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 진행 상황은 어떻게 확인하나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-sky-600">대시보드에서 실시간으로 확인할 수 있습니다.</strong> 주문 내역, 진행 중인 작업, 완료된 백링크 수, 사용한 크레딧, 남은 크레딧 등 모든 정보가 한눈에 보입니다. 또한 각 주문별로 상세 페이지에서 백링크 리스트, 인덱싱 상태, 순위 변화 그래프를 확인할 수 있으며, <strong className="text-gray-900">모바일에서도 동일하게 이용</strong> 가능합니다.
              </p>
            </div>

            {/* 기술적 질문 */}
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-emerald-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 어떤 백링크 유형을 선택해야 하나요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-emerald-600">사이트 상태와 목표에 따라 다릅니다.</strong> 신규 사이트는 플랜 백링크로 다양한 링크 프로필을 먼저 구축하고, 기존 사이트는 PBN 백링크로 강력한 링크 파워를 전달하는 것이 효과적입니다. 무료 컨설팅에서 사이트 진단 후 <strong className="text-gray-900">맞춤 백링크 조합을 제안</strong>해드립니다.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-blue-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 플랜 백링크와 PBN 백링크의 차이는?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-blue-600">플랜 백링크는 다양성, PBN 백링크는 강력함에 초점을 둡니다.</strong> 플랜 백링크는 10가지 이상 유형(WEB2.0, EDU, GOV, Wiki 등)을 조합해 자연스러운 링크 프로필을 만들고, PBN 백링크는 직접 구축한 고권위 사이트에서 강력한 링크 파워를 전달합니다. <strong className="text-gray-900">일반적으로 플랜 백링크로 기반을 다지고 PBN으로 순위를 끌어올립니다</strong>.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-purple-500 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-purple-600">티어 링크는 백링크를 가리키는 백링크로, 링크 파워를 증폭시킵니다.</strong> 티어1(고객 사이트로 직접 연결), 티어2(티어1 백링크를 가리킴), 티어3(티어2 백링크를 가리킴) 구조로, 피라미드처럼 링크 파워를 전달합니다. 예를 들어 PBN 백링크(티어1) 10개에 플랜 백링크(티어2) 100개를 연결하면, <strong className="text-gray-900">티어1 백링크의 권위가 10배 강해집니다</strong>. 경쟁 키워드에 필수적입니다.
              </p>
            </div>

            {/* 산업/대상 */}
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-teal-500 hover:shadow-xl transition-all">
              <p className="font-bold text-gray-900 mb-3 text-lg">Q. 모든 산업군에 적용 가능한가요?</p>
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-teal-600">네, 이커머스, 서비스업, B2B, SaaS, 블로그 등 모든 산업에 적용 가능합니다.</strong> 의류 쇼핑몰(47위→3위), 치과 클리닉(검색 안됨→7위), 마케팅 툴(23위→2위), 법률 사무소, 부동산, 온라인 교육, 헬스케어 등 1,247개 프로젝트에서 검증되었습니다. 단, 도박, 성인, 불법 사이트는 <strong className="text-gray-900">서비스 제공이 불가능</strong>합니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-cyan-500 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-cyan-600">네, 신규 사이트도 가능하지만 전략이 다릅니다.</strong> 신규 사이트(도메인 나이 3개월 미만)는 갑작스런 대량 백링크가 부자연스러우므로, 플랜 백링크를 천천히 쌓아가는 전략을 추천합니다. 월 10-20개씩 3-6개월에 걸쳐 자연스럽게 구축하면, <strong className="text-gray-900">신규 사이트도 6개월 내 1페이지 진입</strong>이 가능합니다. 무료 컨설팅에서 신규 사이트 맞춤 전략을 제시합니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-green-500 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-green-600">네, 영어 사이트는 물론 다국어 사이트도 가능합니다.</strong> 우리의 PBN과 백링크 네트워크는 주로 영어 기반이므로, 오히려 영어 사이트가 더 효과적입니다. 한국어 사이트도 가능하지만, 앵커 텍스트와 콘텐츠를 한국어로 작성하기 위해 추가 비용이 발생할 수 있습니다. <strong className="text-gray-900">영어 사이트는 한국어 사이트보다 20-30% 저렴</strong>합니다.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              <strong className="text-yellow-300">무료 300 크레딧</strong>으로 먼저 테스트하고 결정하세요
            </p>
      ...
      <footer className="bg-gray-900 text-gray-300 pt-16 pb-8">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                직접 구축한 PBN과 10가지 이상 백링크 유형으로<br />
                2~4주 내 순위 상승을 경험하세요
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/products" className="hover:text-white transition-colors">플랜 백링크</Link></li>
                <li><Link href="/products" className="hover:text-white transition-colors">PBN 백링크</Link></li>
                <li><Link href="/products" className="hover:text-white transition-colors">내부 최적화</Link></li>
                <li><Link href="/products" className="hover:text-white transition-colors">사이트 제작</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="mt-4">
                  ...
                  <a href="mailto:support@backlink-shop.com" className="hover:text-white transition-colors">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-500 text-sm">
            ...
            <p className="mt-2">
              <strong className="text-gray-400">1,247개 프로젝트</strong>가 백링크샵으로 순위를 올렸습니다
            </p>
          </div>
        </div>
      </footer>
